...
const products: Product[] = [
    ...
    },
    {
        ...
        lowestPrice: 4133.00,
        highestPrice: 7990.90,
        averagePrice: 5107.90,
        specifications: {
    ...
    },
    {
        ...
        lowestPrice: 4133.99,
        highestPrice: 7990.99,
        averagePrice: 5107.99,
        specifications: {
            emphasis: 'NVIDIA GeForce RTX 2060',
    ...
    },
    {
        ...
        description: 'O processador AMD Ryzen 9 7950X3D redefine o desempenho de jogos e produtividade, com 16 núcleos e 32 threads e cache total de 128MB. Frequência de boost de até 5,7 GHz, ideal para cargas intensas de trabalho e multitarefa.',
        mark: 'AMD',
    ...
    },
    {
        ...
        description: 'O Razer BlackWidow V3 é equipado com switches mecânicos Razer Green para uma resposta tátil precisa e feedback auditivo satisfatório. Possui iluminação RGB Razer Chroma e estrutura em alumínio para maior durabilidade.',
        mark: 'Razer',
    ...
    },
    {
        ...
        description: 'Com switches Cherry MX Red, o Corsair K70 RGB MK.2 oferece resposta linear e silenciosa. Construído em alumínio escovado, ideal para sessões longas de gameplay, e com iluminação RGB dinâmica.',
        mark: 'Corsair',
        model: 'CH-9109010-NA',
    ...
    },
    {
        ...
        description: 'O Redragon Draconic K530 é um teclado mecânico compacto, sem fio, projetado para máxima portabilidade e desempenho. Equipado com switches Outemu Brown, ideal para quem busca um equilíbrio entre feedback tátil e silêncio, além de conectividade Bluetooth.',
        mark: 'Redragon',
        model: 'K530-RGB',
        ...
        specifications: {
            ...
            lighting: 'RGB',
            structure: 'Plástico ABS reforçado',
            keystrokes: '61(Layout 60 %)',
            'Anti-Ghosting': 'Sim, N-Key Rollover',
            weight: '600 g',
        },
    },
    {
        ...
        description: 'O Logitech G403 Hero é equipado com o sensor HERO 25K, oferecendo precisão máxima com até 25.600 DPI ajustáveis. Design ergonômico, estrutura leve e peso ajustável, ideal para quem busca conforto e alto desempenho em jogos.',
        mark: 'Logitech',
        model: '910-005631',
        ...
        specifications: {
            ...
            structure: 'Plástico ABS e borracha texturizada',
            weight: '87 g (com peso ajustável de 10 g)',
        },
    },
    {
        id: 16,
        name: 'Mouse Gamer Razer DeathAdder V2',
        description: 'O Razer DeathAdder V2 possui o sensor ótico Focus+ de 20.000 DPI, com switches ópticos para cliques mais rápidos e durabilidade de até 70 milhões de cliques. Design ergonômico e leve, com cabo SpeedFlex para movimentos sem arrasto.',
        mark: 'Razer',
        ...
        specifications: {
            ...
            structure: 'Plástico ABS texturizado',
            weight: '88 g',
        },
    },
    {
        ...
        description: 'O HyperX Pulsefire FPS Pro é ideal para jogadores que buscam precisão e conforto. Equipado com o sensor Pixart 3389 de até 16.000 DPI e botões Omron com alta durabilidade. Iluminação RGB personalizável e design ergonômico.',
        mark: 'HyperX',
        model: 'HyperX',
        ...
        specifications: {
            ...
            lighting: 'RGB',
            'Tempo de Resposta': '1ms',
            structure: 'Plástico ABS com laterais texturizadas',
            weight: '95 g',
        },
    },
    {
        ...
        description: 'O HyperX Cloud II é um headset projetado para máximo conforto e qualidade de som. Possui drivers de 53mm e som surround virtual 7.1, ideal para gamers que buscam imersão completa em jogos.',
        mark: 'HyperX',
        model: 'KHX-HSCP-RD',
        ...
        specifications: {
            ...
            microphone: 'Removível com cancelamento de ruído',
    ...
    },
    {
        ...
        description: 'O Razer Kraken X é um headset ultraleve com som surround 7.1 e almofadas em espuma com memória para máximo conforto. Microfone cardioide e estrutura reforçada para durabilidade.',
        mark: 'Razer',
        ...
        specifications: {
            ...
            microphone: 'Cardioide não removível',
    ...
    },
    {
        ...
        description: 'O Samsung Odyssey G7 possui taxa de atualização de 240Hz e tempo de resposta de 1ms. Com painel curvo QHD e tecnologia G-Sync, é ideal para gamers que buscam desempenho e imersão.',
        mark: 'Samsung',
    ...
    },
    {
        ...
        description: 'O LG UltraGear 34" é um monitor ultra-wide com resolução WQHD (3440x1440), taxa de atualização de 160Hz e suporte a G-Sync. Ideal para quem busca um monitor para jogos e produtividade.',
        mark: 'LG',
        model: '34GN850-B',
    ...
    },
    {
        ...
        description: 'A RTX 3060 Ventus 2X MSI é equipada com 12GB GDDR6, oferecendo desempenho de última geração para jogos 4K e Ray Tracing. Possui suporte a DLSS e tecnologias avançadas da NVIDIA para máxima performance.',
        mark: 'MSI',
    ...
    },
    {
        ...
        description: 'A RX 6800 XT possui 16GB GDDR6 e arquitetura RDNA 2, proporcionando excelente desempenho em jogos 1440p e 4K. Inclui suporte a Ray Tracing e tecnologia Smart Access Memory para CPUs Ryzen.',
        mark: 'ASRock',
    ...
    },
    {
        ...
        description: 'A ROG Strix Z590-E é uma placa-mãe premium para processadores Intel de 11ª geração, com suporte a overclock, Wi-Fi 6E integrado e iluminação RGB ASUS Aura Sync.',
        mark: 'ASUS',
    ...
    },
    {
        ...
        description: 'A MAG B550 Tomahawk é uma placa-mãe robusta para CPUs AMD Ryzen, oferecendo suporte a PCIe 4.0 e design térmico otimizado com dissipadores estendidos para maior estabilidade.',
        mark: 'MSI',
        model: 'B550 TOMAHAWK',
    ...
    },
    {
        ...
        description: 'O kit Corsair Vengeance RGB Pro oferece desempenho de alto nível para jogadores e criadores de conteúdo, com 16GB de capacidade, frequência de 3200MHz e iluminação RGB dinâmica.',
        mark: 'Corsair',
    ...
    },
    {
        ...
        description: 'A Kingston Fury Beast é projetada para usuários que necessitam de capacidade extra. Com 32GB e frequência de 3200MHz, é ideal para multitarefa avançada e jogos pesados, mantendo baixa latência.',
        mark: 'Kingston',
    ...
    },
    {
        ...
        description: 'O PlayStation 5 Slim oferece gráficos de nova geração com suporte a Ray Tracing, tempos de carregamento rápidos com seu SSD customizado e jogos exclusivos que definem a plataforma.',
        mark: 'Sony',
        model: 'CFI-1015A',
